...
![image](https://github.com/suous/RepNeXt/blob/main/figures/latency.png)
![image](https://github.com/suous/RepNeXt/blob/main/figures/architecture.png)
![image](https://github.com/suous/RepNeXt/blob/main/figures/transforms.png)
...
[segmentation_dataset](https://pan.baidu.com/s/1LLyIlP3sjuoFAwTBaYflRQ?pwd=0615)  
...
[pretrained_weights](https://github.com/suous/RepNeXt/blob/main/README.md#classification-on-imagenet-1k). 
...
├── models: RepNext Model
    ├── build_cls_models.py: Construct RepNext models for image classification
    ├── build_seg_backbones.py: Construct RepNext models as backbones for image segmentation
    ├── build_seg_models.py: Construct RepNext models for image segmentation
    ├── fpn_seg_head.py: Construct FPN Head
    ├── mask_rcnn_seg_head.py: Construct MaskRCNN Head
├── scheduler:
...
```bash
python onnx_export.py --model=repnext_m1 --output=./repnext_m1.onnx --checkpoint=./output/repnext_m1_best_checkpoint.pth
```

### step2: ONNX optimise
```bash
python onnx_optimise.py --model=repnext_m1 --output=./repnext_m1_optim.onnx
```

### step3: ONNX validate (modify the param of ___data_root___ and ___onnx-input___)  
```bash
python onnx_validate.py --data_root=/mnt/d/flower_data --onnx-input=./repnext_m1_optim.onnx
```
