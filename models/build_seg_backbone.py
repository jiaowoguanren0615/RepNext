...
def repnext_m1(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    return RepNext(embed_dim=(48, 96, 192, 384), depth=(3, 3, 15, 2), **kwargs)


def repnext_m2(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    return RepNext(embed_dim=(56, 112, 224, 448), depth=(3, 3, 15, 2), **kwargs)


def repnext_m3(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    return RepNext(embed_dim=(64, 128, 256, 512), depth=(3, 3, 13, 2), **kwargs)


def repnext_m4(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    return RepNext(embed_dim=(64, 128, 256, 512), depth=(5, 5, 25, 4), **kwargs)


def repnext_m5(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    return RepNext(embed_dim=(80, 160, 320, 640), depth=(7, 7, 35, 2), **kwargs)
